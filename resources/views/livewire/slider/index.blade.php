            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            @can('add-slider')
                                <a class="btn bg-gradient-dark mb-0 me-4" href="{{ route('add-slider') }}"><i
                                        class="material-icons text-sm">add</i>&nbsp;&nbsp;Add Slider</a>
                            @endcan
                        </div>
                    </div>
                </div>
                ...
                <x-table>
                    ...
                    <x-slot name="head">
                       ...
                       <x-table.heading sortable wire:click="sortBy('start_date_time')"
                            :direction="$sortField === 'start_date_time	' ? $sortDirection : null">
                            Start Date Time	
                        </x-table.heading>
                        <x-table.heading sortable wire:click="sortBy('end_date_time')"
                            :direction="$sortField === 'end_date_time' ? $sortDirection : null">
                            End Date Time
                        </x-table.heading>
                    ...
                    <x-slot name="body">
                        ...
                        <x-table.row wire:key="row-{{ $slider->id }}">
                            ...
                            <x-table.cell>{{ $slider->name }}</x-table.cell>   
