                ...
                <div class="card-body pt-0">
                    <form wire:submit.prevent="store">
                        <div class="row">
                            ...
                            <div class="col-12 mb-4">                                
                                <div class="input-group input-group-static" x-data x-init="flatpickr($refs.start_date, {allowInput: false, enableTime: 'true',
                                    dateFormat: 'Y-m-d H:i'});">
                                        ...
                                        <input wire:model.lazy="start_date" x-ref="start_date" class="form-control" type="text" placeholder="Enter a Start Date Time" />
                                </div>
                                @error('start_date')
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                                @enderror                              
                            ...
                            @if(!$never_expired)
                                <div class="col-12 mb-4">
                                    <div  class="input-group input-group-static" x-data x-init="flatpickr($refs.end_date, {allowInput: false,enableTime: 'true',
                                            ...
                                            <input wire:model.lazy="end_date" x-ref="end_date" class="form-control flatpickr" type="text"  placeholder="Enter a End Date Time" />
                                    </div> 
                                    @error('end_date')
                         ...
                         {{--    @if($discount_on == 'selected_store')
                                <div  class="col-12 mb-4">
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input class="form-check-input" wire:model.lazy="allow_participant"  type="checkbox" Checked>
                                            <label class="form-check-label">Allow Participants to join</label>
                                            </div>
                                    </div>
                                    @error('allow_participant')
                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                    @enderror
                                </div> 
                            @endif
