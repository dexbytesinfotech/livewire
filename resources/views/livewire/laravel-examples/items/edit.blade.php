                ...
                <div class="card-body">
                    <form wire:submit.prevent="update" class='d-flex flex-column align-items-center'
                        ...
                        <div class="form-group col-12 col-md-6 mt-3">
                            ...
                            <input wire:model.lazy="item.name" type="name" class="form-control border border-2 p-2"
                        ...
                        <div class="form-group col-12 col-md-6 mt-3">
                            ...
                            <select wire:model.lazy="item.category_id" class="form-select border border-2 p-2"
                        ...
                        <div class="form-group col-12 col-md-6 mt-3">
                            ...
                            <div class="form-check">
                                <input wire:model="item.status" class="form-check-input" type="radio" id="draft"
                                    value='draft'>
                            ...
                            <div class="form-check">
                                <input wire:model="item.status" class="form-check-input" type="radio" id="archive"
                                    value='archive'>
                        ...
                        <div class="form-check form-switch col-12 col-md-6 mt-3">
                            <label class="form-check-label" for="flexSwitchCheckDefault">Show on
                                homepage</label>
                            <input wire:model="item.homepage" class="form-check-input" type="checkbox"
                        ...
                        <div class="form-group col-12 col-md-6 mt-3">
                            ...
                            <div class="form-check">
                                <input wire:model="item.options" class="form-check-input" type="checkbox"
                        ...
                        <div class="form-group col-12 col-md-6 mt-3">
                            ...
                            <input wire:model="item.date" type="date"
