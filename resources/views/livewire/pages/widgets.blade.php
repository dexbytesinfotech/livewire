        ...
        <div class="col-lg-5">
            <div class="card widget-calendar">
                ...
                <div class="card-header p-3 pb-0">
                    ...
                    <div class="d-flex">
                        <div class="p text-sm font-weight-normal mb-0 widget-calendar-day"></div>
                        <span>,&nbsp;</span>
                        <div class="p text-sm font-weight-normal mb-1 widget-calendar-year"></div>
                    </div>
                </div>
                <!-- Card body -->
                <div class="card-body p-3">
                    ...
                    <div class="timeline timeline-one-side">
                        <div class="timeline-block mb-3">
                            ...
                            <div class="timeline-content">
                                ...
                                <p class="text-secondary font-weight-normal text-xs mt-1 mb-0">22 DEC 7:20 PM
                                </p>
                            </div>
                        </div>
                        <div class="timeline-block mb-3">
                            ...
                            <div class="timeline-content">
                                ...
                                <p class="text-secondary font-weight-normal text-xs mt-1 mb-0">21 DEC 11 PM</p>
                            </div>
                        </div>
                        <div class="timeline-block mb-3">
                            <span class="timeline-step">
                            ...
                            <div class="timeline-content">
                                ...
                                <p class="text-secondary font-weight-normal text-xs mt-1 mb-0">21 DEC 9:34 PM
                                </p>
                            </div>
                        </div>
                        <div class="timeline-block mb-3">
                            ...
                            <div class="timeline-content">
                                <h6 class="text-dark text-sm font-weight-bold mb-0">New card added for order
                                    #4395133</h6>
                                <p class="text-secondary font-weight-normal text-xs mt-1 mb-0">20 DEC 2:20 AM
                                </p>
                            </div>
                        </div>
                        <div class="timeline-block mb-3">
                            ...
                            <div class="timeline-content">
                                <h6 class="text-dark text-sm font-weight-bold mb-0">Unlock packages for
                                    development</h6>
                                <p class="text-secondary font-weight-normal text-xs mt-1 mb-0">18 DEC 4:54 AM
                                </p>
                            </div>
                        </div>
                        <div class="timeline-block mb-3">
                            ...
                            <div class="timeline-content">
                                <h6 class="text-dark text-sm font-weight-bold mb-0">Fix payment issues</h6>
                                <p class="text-secondary font-weight-normal text-xs mt-1 mb-0">18 DEC 1:40 AM
                                </p>
                            </div>
                        </div>
                    </div>
