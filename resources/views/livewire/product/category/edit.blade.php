                        ...
                        <div class="row ">
                            <div class="col-12  mb-4">
                                <div class="input-group input-group-static">
                                    <label>Name *</label>
                                    <input wire:model.lazy="category.name" type="text" class="form-control" placeholder="Enter a Name">
                                </div>
                                @error('category.name')
                                ...
                                <div class="input-group input-group-static">
                                    ...
                                    <div wire:ignore class="h-200 m-2 me-1 ms-auto w-100">
                                        <div x-data x-ref="quill" x-init="quill = new Quill($refs.quill, {theme: 'snow',});
                                            ...
                                            x-on:quill-text-change.debounce.200ms="@this.set('category.description', $event.detail)">
                            ...
                            <div class="col-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input wire:model="category.status" class="form-check-input" type="checkbox"  id="flexCheckFirst">
                                ...
                                <div class="avatar avatar-xl m-2 position-relative rounded-circle">
                                    <div class="position-relative preview">
                                        ...
                                        <span class="h-12 w-12 rounded-full overflow-hidden bg-gray-100 ">
                                            ...
                                            <img src="/storage/{{$category->image}}" alt="avatar"
