                        ...
                        <!-- <div class="col-12 col-sm-6 mt-6 mt-sm-6">
                            <div class="input-group input-group-static">
                                <div class="form-check form-switch ms-3">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault35" wire:model="product.is_featured">
                                </div>
                                @error('product.is_featured')
                                <p class='text-danger inputerror'>{{ $message }} </p>
                                @enderror
                            </div>
                        </div> -->
                ...
                <div class="card-body pt-0">                  
                    <div class="row mt-3">
                        <div class="col-12 col-sm-6">
                            <div class="input-group input-group-static">
                                <label>Price *</label>
                                <input wire:model.lazy="product.price" class="multisteps-form__input form-control" type="text" placeholder="Enter Price" />
                            </div>
                            @error('product.price')
                            <p class='text-danger inputerror'>{{ $message }} </p>
                            @enderror
                        ...
                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                            <div class="input-group input-group-static">
                                ...
                                <input wire:model.lazy="product.price_sale" class="multisteps-form__input form-control" type="text" placeholder="Enter a Price sale" />
                            </div>
